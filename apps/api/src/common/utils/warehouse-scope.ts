 ...
 * işaretli bir Ana Depo (bağımsız depo — bkz. WarehousesService.create) ve tüm alt ağacı bu
 * havuzdan hariç tutulur, kendi sekmesinde/bağlamında normal şekilde durmaya devam eder.
 */
